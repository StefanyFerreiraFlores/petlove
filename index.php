...
<main>
    ...
    <div class="container">
        ...
        <!-- Main Image -->
        <div class="main-img">
            <img src="img/banhoetosa.png" alt="">
        </div>
        <!-- Fim Main Image -->
    </div>
    <!-- Fim Container -->
...
<section class="pet">
    <div class="container">
        ...
        <div class="pet-text">
            <h2>Pet Love</h2>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has sobrevivido não apenas cinco séculos, mas também o salto para a composição eletrônica, permanecendo essencialmente inalterado.</p>
...
<section class="subscreva-se">
    <div class="container">
        <div class="box-sub">
            <h2>Subescreva-se na Pet Love</h2>
            <p>Subeescreva-se para receber dicas, noticias e informaçoes.</p>
            <form>
                <input type="email" placeholder="Digite seu email">
                <button>Subeescrever</button>
            </form>
        </div>
    </div>
</section>
